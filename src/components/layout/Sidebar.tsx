...
import {
  ...
  Sparkles, ChevronLeft, ChevronRight, Zap, Building2
} from 'lucide-react';
    ...
    >
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {isActive && (
                  <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 rounded-r bg-sky-400" />
                )}
                {collapsed && (
      ...
      <div className="p-4 border-t border-white/8">
        <div className={`flex items-center gap-3 ${collapsed ? 'justify-center' : ''}`}>
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-sky-600 to-sky-400 flex items-center justify-center flex-shrink-0">
            <Zap size={14} className="text-white" />
          </div>
          {!collapsed && (
            <div className="text-xs text-slate-400">
              <div className="text-white font-medium">AI Model v2.1</div>
